...
import { InvocationService } from 'src/app/Services/invocation.service';
...
export class InvocationsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.invocationService.getInvocations().subscribe((invocations) => {
      this.invocations = invocations;
      console.log('Got invocations');
